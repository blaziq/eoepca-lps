...
if [[ -e /tmp/assets/localdns ]]; then
  ...
  DOMAIN="eoepca.local"
  SERVICES="minio minio-console zoo resource-catalogue registration-api registration-harvester-api eoapi eoapisupport maps datacube-access workspace-api app-hub"

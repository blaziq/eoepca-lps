We have learned in this tutorial how to deploy a sample EOEPCA Processing Building Block, with a [OGC Process API](https://ogcapi.ogc.org/processes/) interface and a Calrissian Kubernetes engine!
